...
const WalletOverlay: FC<WalletOverlayProps> = ({
    display,
    onClose,
}) => {
            ...
            { display && (
                <Overlay>
                    <Container>
                        ...
                        <ListContainer>
                            <NetworkButton
                                onClick={() => console.log('You clicked on the browser wallet button!')}
                            >
                                <Image src={MetamaskIcon} priority={true}/>
                                <span>Browser Wallet</span>
                            </NetworkButton>
                            <NetworkButton
                                onClick={() => console.log('You clicked on the connect mobile wallet button!')}
                            >
                                <Image src={ConnectMobileIcon} priority={true}/>
                                <span>Connect Mobile Wallet</span>
                            </NetworkButton>
                            <NetworkButton
                                onClick={() => console.log('You clicked on the connect ledger button!')}
                            >
                            ...
                            <SeeMoreButton
                                onClick={() => console.log('You clicked on the see more button!')}
                            >
                                <span>See More</span>
                            </SeeMoreButton>
                        </ListContainer>
